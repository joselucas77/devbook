  ...
  async function signInWithGoogle() {
    await authClient.signIn.social({
      ...
      fetchOptions: {
        ...
        onError: (error) => {
          toast.error(error.error.message || "Falha no login com Google");
        },
      },
    });
  }
  ...
  async function signInWithGitHub() {
    await authClient.signIn.social({
      ...
      fetchOptions: {
        ...
        onError: (error) => {
          toast.error(error.error.message || "Falha no login com GitHub");
        },
      },
    });
  }
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="py-4">
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Bem-vindo ao DevBook</CardTitle>
          <CardDescription>
